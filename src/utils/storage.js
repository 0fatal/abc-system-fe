...
export const confirmInput = (role, route, data, tableData) => {
    ...
    if (role === 'staffDirector' && tableData) {
        ...
        const s = {
            ...
            X2: Number(match('刘璐老师')['学生管理']),
            K2: Number(match('刘璐老师')['科研竞赛']),
            S2: Number(match('刘璐老师')['社团管理']),
            D2: Number(match('刘璐老师')['党团建设']),

            X3: Number(match('吕老师')['学生管理']),
            K3: Number(match('吕老师')['科研竞赛']),
            S3: Number(match('吕老师')['社团管理']),
            D3: Number(match('吕老师')['党团建设']),

            X4: Number(match('吕老师')['学生管理']),
            K4: Number(match('吕老师')['科研竞赛']),
            S4: Number(match('吕老师')['社团管理']),
            D4: Number(match('吕老师')['党团建设']),
